@res_automation @hide_unhide_activities @hide_unhide_url_activity @automation_dev
Feature: In order to hide url activities from students
  As a Lecturer
  I can hide and un hide url activities in the course

  @javascript
  Scenario Outline: hide and un hide url activities in the course
    ...
    And the following "activities" exist:
      ...
      | url   | Test url name | Test url desc | C1     | url1   |
