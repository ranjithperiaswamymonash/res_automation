@res_automation @resource @create_book_resource
Feature: Create a moodle book resource
  In order to create a book resource
  As an admin
  I need to be create book resource so that students can use it in course.

  @javascript
  Scenario: Create a moodle book resource
    ...
    And I click on "//span[@class='typename' and text()='Book']" "xpath_element"
