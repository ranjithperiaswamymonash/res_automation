@res_automation @hide_unhide_activities @hide_unhide_scorm_activity @automation_dev
Feature: In order to hide scorm activities from students
  As a Lecturer
  I can hide and un hide scorm activities in the course

  @javascript
  Scenario Outline: hide and un hide scorm activities in the course
    ...
    And the following "activities" exist:
      ...
      | scorm   | Test scorm name | Test scorm desc | C1     | scorm1   |
