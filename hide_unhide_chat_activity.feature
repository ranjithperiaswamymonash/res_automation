@res_automation @hide_unhide_activities @hide_unhide_chat_activity @automation_dev
Feature: In order to hide chat activities from students
  As a Lecturer
  I can hide and un hide chat activities in the course

  @javascript
  Scenario Outline: hide and un hide chat activities in the course
    ...
    And the following "activities" exist:
      ...
      | chat   | Test chat name | Test chat desc | C1     | chat1   |
