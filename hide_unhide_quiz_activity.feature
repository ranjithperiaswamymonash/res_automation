@res_automation @hide_unhide_activities @hide_unhide_quiz_activity @automation_dev
Feature: In order to hide quiz activities from students
  As a Lecturer
  I can hide and un hide quiz activities in the course

  @javascript
  Scenario Outline: hide and un hide quiz activities in the course
    ...
    And the following "activities" exist:
      ...
      | quiz   | Test quiz name | Test quiz desc | C1     | quiz1   |
