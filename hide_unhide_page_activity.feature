@res_automation @hide_unhide_activities @hide_unhide_page_activity @automation_dev
Feature: In order to hide page activities from students
  As a Lecturer
  I can hide and un hide page activities in the course

  @javascript
  Scenario Outline: hide and un hide page activities in the course
    ...
    And the following "activities" exist:
      ...
      | page   | Test page name | Test page desc | C1     | page1   |
