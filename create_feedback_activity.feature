@res_automation @activity @create_feedback_activity @automation_dev

Feature: Create a moodle feedback activity

  In order to create a feedback activity

  As an admin

  I need to be create feedback activity so that students can use it in course.

  @javascript

  Scenario: Create a moodle feedback activity
    ...
    And I click on "//span[@class='typename' and text()='Feedback']" "xpath_element"
    ...
    Then I should see "Test Feedback"
