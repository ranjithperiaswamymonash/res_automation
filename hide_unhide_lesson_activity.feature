@res_automation @hide_unhide_activities @hide_unhide_lesson_activity @automation_dev
Feature: In order to hide lesson activities from students
  As a Lecturer
  I can hide and un hide lesson activities in the course

  @javascript
  Scenario Outline: hide and un hide lesson activities in the course
    ...
    And the following "activities" exist:
      ...
      | lesson   | Test lesson name | Test lesson desc | C1     | lesson1   |
