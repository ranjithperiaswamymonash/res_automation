@res_automation @hide_unhide_activities @hide_unhide_wiki_activity @automation_dev
Feature: In order to hide wiki activities from students
  As a Lecturer
  I can hide and un hide wiki activities in the course

  @javascript
  Scenario Outline: hide and un hide wiki activities in the course
    ...
    And the following "activities" exist:
      ...
      | wiki   | Test wiki name | Test wiki desc | C1     | wiki1   |
