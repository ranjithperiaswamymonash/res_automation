@res_automation @hide_unhide_activities @hide_unhide_data_activity @automation_dev
Feature: In order to hide data activities from students
  As a Lecturer
  I can hide and un hide data activities in the course

  @javascript
  Scenario Outline: hide and un hide data activities in the course
    ...
    And the following "activities" exist:
      ...
      | data   | Test data name | Test data desc | C1     | data1   |
