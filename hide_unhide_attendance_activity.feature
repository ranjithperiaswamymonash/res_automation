@res_automation @hide_unhide_activities @hide_unhide_attendance_activity @automation_dev
Feature: In order to hide attendance activities from students
  As a Lecturer
  I can hide and un hide attendance activities in the course

  @javascript
  Scenario Outline: hide and un hide attendance activities in the course
    ...
    And the following "activities" exist:
      ...
      | attendance   | Test attendance name | Test attendance desc | C1     | attendance1   |
