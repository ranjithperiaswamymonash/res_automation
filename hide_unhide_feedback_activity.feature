@res_automation @hide_unhide_activities @hide_unhide_feedback_activity @automation_dev
Feature: In order to hide feedback activities from students
  As a Lecturer
  I can hide and un hide feedback activities in the course

  @javascript
  Scenario Outline: hide and un hide feedback activities in the course
    ...
    And the following "activities" exist:
      ...
      | feedback   | Test feedback name | Test feedback desc | C1     | feedback1   |
