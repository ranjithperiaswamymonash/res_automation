@res_automation @hide_unhide_activities @hide_unhide_hsuforum_activity @automation_dev
Feature: In order to hide hsuforum activities from students
  As a Lecturer
  I can hide and un hide hsuforum activities in the course

  @javascript
  Scenario Outline: hide and un hide hsuforum activities in the course
    ...
    And the following "activities" exist:
      ...
      | hsuforum   | Test hsuforum name | Test hsuforum desc | C1     | hsuforum1   |
