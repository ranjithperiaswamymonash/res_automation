@res_automation @hide_unhide_activities @hide_unhide_workshop_activity @automation_dev
Feature: In order to hide workshop activities from students
  As a Lecturer
  I can hide and un hide workshop activities in the course

  @javascript
  Scenario Outline: hide and un hide workshop activities in the course
    ...
    And the following "activities" exist:
      ...
      | workshop   | Test workshop name | Test workshop desc | C1     | workshop1   |
