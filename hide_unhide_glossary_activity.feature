@res_automation @hide_unhide_activities @hide_unhide_glossary_activity @automation_dev
Feature: In order to hide glossary activities from students
  As a Lecturer
  I can hide and un hide glossary activities in the course

  @javascript
  Scenario Outline: hide and un hide glossary activities in the course
    ...
    And the following "activities" exist:
      ...
      | glossary   | Test glossary name | Test glossary desc | C1     | glossary1   |
