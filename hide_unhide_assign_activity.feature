@res_automation @hide_unhide_activities @hide_unhide_assign_activity @automation_dev
Feature: In order to hide assign activities from students
  As a Lecturer
  I can hide and un hide assign activities in the course

  @javascript
  Scenario Outline: hide and un hide assign activities in the course
    ...
    And the following "activities" exist:
      ...
      | assign   | Test assign name | Test assign desc | C1     | assign1   |
