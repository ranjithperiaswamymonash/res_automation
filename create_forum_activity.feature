@res_automation @activity @create_forum_activity
Feature: Create a moodle forum activity
  In order to create a forum activity
  As an admin
  I need to be create forum activity so that students can use it in course.

  @javascript
  Scenario: Create a moodle forum activity
    ...
    And I click on "//span[@class='typename' and text()='Forum']" "xpath_element"
    And I click on "//input[@type='submit' and @value='Add']" "xpath_element"
    And I set the following fields to these values:
      | Forum name  | Forum Test             |
