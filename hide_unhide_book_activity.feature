@res_automation @hide_unhide_activities @hide_unhide_book_activity @automation_dev
Feature: In order to hide book activities from students
  As a Lecturer
  I can hide and un hide book activities in the course

  @javascript
  Scenario Outline: hide and un hide book activities in the course
    ...
    And the following "activities" exist:
      ...
      | book   | Test book name | Test book desc | C1     | book1   |
