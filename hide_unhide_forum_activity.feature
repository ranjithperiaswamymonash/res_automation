@res_automation @hide_unhide_activities @hide_unhide_forum_activity @automation_dev
Feature: In order to hide forum activities from students
  As a Lecturer
  I can hide and un hide forum activities in the course

  @javascript
  Scenario Outline: hide and un hide forum activities in the course
    ...
    And the following "activities" exist:
      ...
      | forum   | Test forum name | Test forum desc | C1     | forum1   |
