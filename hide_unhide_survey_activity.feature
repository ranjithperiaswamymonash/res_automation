@res_automation @hide_unhide_activities @hide_unhide_survey_activity @automation_dev
Feature: In order to hide survey activities from students
  As a Lecturer
  I can hide and un hide survey activities in the course

  @javascript
  Scenario Outline: hide and un hide survey activities in the course
    ...
    And the following "activities" exist:
      ...
      | survey   | Test survey name | Test survey desc | C1     | survey1   |
