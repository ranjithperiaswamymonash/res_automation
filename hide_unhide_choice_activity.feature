@res_automation @hide_unhide_activities @hide_unhide_choice_activity @automation_dev
Feature: In order to hide choice activities from students
  As a Lecturer
  I can hide and un hide choice activities in the course

  @javascript
  Scenario Outline: hide and un hide choice activities in the course
    ...
    And the following "activities" exist:
      ...
      | choice   | Test choice name | Test choice desc | C1     | choice1   |
